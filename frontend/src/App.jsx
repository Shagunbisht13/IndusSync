...
export default function App() {
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute("download", "IntelliPIM_Delivery_Format.csv");
                ...
                <div className="panel" style={{padding: '1.5rem'}}>
                  ...
                  {!results[selectedRow.Mfg_Part_Num] && !enriching && (
                    <div style={{textAlign: 'center', padding: '4rem 0', color: 'var(--text-secondary)'}}>
                      <p>Click "Fix Data with AI" to let IntelliPIM generate perfect text.</p>
                    </div>
                  )}
          ...
          <div className="panel" style={{padding: '3rem', minHeight: '60vh'}}>
             <div style={{textAlign: 'center', marginBottom: '3rem'}}>
              ...
              <p style={{color: 'var(--text-secondary)', maxWidth: '600px', margin: '0 auto', fontSize: '0.875rem'}}>
                IntelliPIM automatically moves items from messy supplier folders into your clean, organized store categories.
              </p>
            </div>
          ...
          <div className="panel" style={{padding: '3rem', textAlign: 'center'}}>
            ...
            <div style={{padding: '2rem', background: 'var(--bg-main)', borderRadius: '8px', border: '1px solid var(--border-color)', textAlign: 'left'}}>
              ...
              <p style={{fontSize: '0.875rem', color: 'var(--text-secondary)', lineHeight: '1.6'}}>
                The data you received is full of errors and placeholder text. By clicking the <strong style={{color: 'var(--text-primary)'}}>Batch Enrich</strong> button, IntelliPIM will automatically read the messy text, find hidden specs like Voltage, fix the brand names, and give you perfectly clean data ready for your customers!
              </p>
            </div>
          </div>
        )}
